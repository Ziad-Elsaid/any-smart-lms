...
export async function fetchInstructorCourseListService(instructorId) {
  const { data } = await axiosInstance.get(
    `/instructor/course/get/instructor/${instructorId}`
  );
...
export async function updateUserService(id, formData) {
...
export async function changePasswordService(id, passwordData) {
  const { data } = await axiosInstance.put(`/user/change-password/${id}`, passwordData);
